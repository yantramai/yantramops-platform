...
import json
import yaml
from core.base import YantramProcessor as yantram


class Executer:

    def download_charts(deployment_file):
        yantram.download_charts(deployment_file='deployments.yaml')
            ...
            for deployment_module in deployments:
                ...
                try:
                    ...
                    if lifecycle_event == 'create':
                        ...
                        out_create_work = yantram.invoke_process(yantram.terraform_workspace_select)
                    ...
                    if lifecycle_event == 'destroy':
                        ...
                        yantram.invoke_process(yantram.terraform_destroy + ['-force'])
